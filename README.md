...
XiVPN is a GUI client for [Xray core](https://github.com/XTLS/Xray-core). It aims to provide an
...
- **Running xray as an independent process** Runs the Xray core as a separate process, preventing memory
...
I am a broke college student. Please sponsor me :)
